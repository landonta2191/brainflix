        ...
        <section className="video__section">
          ...
          <div className="video__section--comments">
            ...
            <div className="video__section--icons">
              <div>
                <img className="up" alt="up" src="/Assets/Icons/Thumbs Up.svg" ></img>
                <h5>{videos.thumbsUp}</h5>              
              </div>
              <div>
                <img className="down" alt="down" src="/Assets/Icons/Thumbs Down.svg" ></img>
                <h5>{videos.thumbsDown}</h5>
              </div>
              <div>
                <img className="share" alt="share" src="/Assets/Icons/Share.svg"></img>
                <h5>SHARE</h5>
              </div>
            </div>
          </div>
